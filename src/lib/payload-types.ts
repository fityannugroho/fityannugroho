...
export interface Role {
  id: number;
  /**
   * Unique key for the role. Will be converted to lowercase
   */
  key: string;
  /**
   * The unique human-readable label for the role
   */
  label: string;
  /**
  ...
  /**
   * Permissions that are allowed for this role
   */
  permissions?: {
    docs?: (number | Permission)[];
    hasNextPage?: boolean;
    totalDocs?: number;
  };
  updatedAt: string;
...
export interface Permission {
  ...
  /**
   * Grant access if the resource that is being accessed is in a specific state/status.
   */
  allowedIf?: ("published" | "draft")[] | null;
  updatedAt: string;
  createdAt: string;
}
/**
...
export interface Project {
  ...
  image: number | Media;
  sourceCode?: {
    gitProvider?: ("github" | "gitlab" | "bitbucket" | "other") | null;
