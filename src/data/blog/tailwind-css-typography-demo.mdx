---
id: "tailwind-css-typography-demo"
title: "Tailwind CSS Typography Demo"
summary: "A demo of the Tailwind CSS Typography plugin"
postDate: "2024-01-31"
tags: ["tailwind", "typography", "plugin"]
cover:
  file: "./images/tailwind-css-typography-demo.webp"
  alt: "Screenshot of the Tailwind CSS Typography Playground"
---

{/* prettier-ignore */}
<p class="lead">Until now, trying to style an article, document, or blog post with
Tailwind has been a tedious task that required a keen eye for typography and a lot of
...
UIs because you spend less time undoing user-agent styles, but when you really are
...
really want your blog posts to use the user-agent styles either — you want
them to look awesome, not awful.

The `@tailwindcss/typography` plugin is our attempt to give you what you _actually_
want, without any of the downsides of doing something stupid like disabling
our base styles.

It adds a new `prose` class that you can slap on any block of vanilla HTML content
...
block quotes, and even _italics_.

It's important to cover all of these use cases for a few reasons:

1. We want everything to look good out of the box.
1. Really just the first reason, that's the whole point of the plugin.
1. Here's a third pretend reason though a list with three items looks more
...
<figure>
  ...
  2000 years old.</figcaption>
</figure>

This is another image that using image markdown syntax `![]()`:

![A photo of cafe interior.](https://images.unsplash.com/photo-1554118811-1e0d58224f24)
...
- **I often do this thing where list items have headings.**
  ...
  part is getting the spacing between the paragraphs, list item heading, and s
  eparate list items to all make sense. Pretty tough honestly, you could make a
  strong argument that you just shouldn't write this way.

- **Since this is a list, I need at least two items.**

  So here's another one. I could have made this a list of three items but I
  think you get the point with just two.
...
code blocks but it wouldn't hurt to make them look okay out of the box, even
...
- **But in this second top-level list item, they will.**
  ...
  - As you can see here, because I've added a second line,
    this list item now has a `<p>` tag.
...
| ----------------------- | ---------------------- | -------------------- |
| Stone Cold Steve Austin | Victoria, Texas        | Stone Cold Stunner   |
| The Rock                | Miami, Florida         | Rock Bottom          |
| Triple H                | Greenwich, Connecticut | Pedigree             |
| The Undertaker          | Death Valley           | Tombstone Piledriver |

We also need to make sure inline code looks good, like if I wanted to talk
about `<span>` elements or tell you the good news about `@tailwindcss/typography`.

### Sometimes I even use `code` in headings

Even though it's probably a bad idea, and historically I've had a hard time
making it look good. This "_wrap the code blocks in backticks_" trick works
pretty well though really.

Another thing I've done in the past is put a `code` tag inside of a link, like if
...
supports two heading levels for a reason. I honestly considered
...
small that they are the same size as the body copy. What are we supposed to
do with an `h5`, make it _smaller_ than the body copy? No thanks.
...
block of text. I can't explain why I want things to end that way but I have
to assume it's because I think things will look weird or unbalanced if there
...
Check out the original demo page on
[**Tailwind Play**](https://play.tailwindcss.com/uj1vGACRJA?layout=preview)
which was was written using HTML.

Instead, **this page** is written in Markdown.
See the code
[here](https://github.com/fityannugroho/fityannugroho/blob/main/src/content/blog/tailwind-css-typography-demo.mdx).
